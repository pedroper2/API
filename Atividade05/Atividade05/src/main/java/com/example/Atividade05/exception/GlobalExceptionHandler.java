package com.example.Atividade05.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EmailJaCadastratoExeception.class)
    public ResponseEntity<Map<String, Object>> handlerEmailJaCadastrado(EmailJaCadastratoExeception erro){
        return ResponseEntity
